...
<div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
				...
				<div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter offer title" name="t1">
                    </div>
					
					<div class="form-group">
                        <label for="exampleInputEmail1">Offer Description</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter offer description" name="t2">
                    </div>
	...
	?>
    <tr>
        <td><?php echo $c["o_id"];?></td>
		<td class="center"><?php echo $c["o_title"];?></td>
		<td class="center"><?php echo $c["o_descr"];?></td>
		<td class="center"><img src="img/<?php echo $c["o_img"];?>" height="50px" width="50px"></td>
		<td class="center">
            
          
			<a class="btn btn-info" href="offer_edit.php?edit=<?php echo $c["o_id"];?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger" href="offer.php?delt=<?php echo $c["o_id"];?>">
...
{
   $del = "delete from offer_tb where o_id = '$_REQUEST[delt]'";
