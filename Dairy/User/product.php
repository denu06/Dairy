		...
		?>
		           <div class="project-top-grid">
					<div class="col-md-4 project-grid">
						<div class>
							 <a href="product_details.php?id=<?php echo $v['p_id'];?>" class="mask"><img src="../Admin/img/<?php echo $v["p_img"];?>" class="img-responsive zoom-img" alt=""/ style="width:200px; height:300px"></a>
							 <div class="col-md1">
								 <div class="col-md2">
								 ...
								 <a href="product_details.php?id=<?php echo $v['p_id'];?>" class="hvr-sweep-to-right more">See Details</a>
							 </div>
						</div>
					</div>
					</div>
