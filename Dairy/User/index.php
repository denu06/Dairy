			    ...
			    <div class="callbacks_container">
			      <ul class="rslides" id="slider">		       
					 <li>
			          	 <div class="banner1">
			           		<div class="caption">
					          	...
					          	<h3><span style="font-family:Comic Sans MS; font-size:50px"><strong>WELCOME</strong></span></h3>
					 ...
					 <li>
			          	 <div class="banner2">
			           		<div class="caption">
					          	<h3><span style="font-family:Comic Sans MS; font-size:50px; font-stretch:wider; text-transform:uppercase"><strong>Welcome</strong></span></h3>
								<p style="font-family:Comic Sans MS; font-size:36px">Product- Packing - Pasteurised</p>
			          		</div>
			          	</div>
			         </li>
			         <li>
			          	 <div class="banner3">
			           		<div class="caption">
					          	<h3><span style="font-family:Comic Sans; font-size:50px; font-stretch:wider; text-transform:uppercase"><strong>Welcome</strong></span></h3>
								<p style="font-family:Comic Sans MS; font-size:36px">Product- Packing - Pasteurised</p>
			          		</div>
			          	</div>
			         </li>		
